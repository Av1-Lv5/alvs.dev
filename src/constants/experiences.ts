export const experiences = [
	...
	},
	{
		...
		points: [
			{
				label: "Client work",
				text: "Built admin portals and custom tools for colleges and businesses.",
			},
			{
				label: "Full cycle",
				text: "From vague ideas to design, build, and launch.",
			},
			{
				label: "Mentoring",
				text: "Guided newer devs on projects and problem-solving.",
			},
		],
	},
	{
